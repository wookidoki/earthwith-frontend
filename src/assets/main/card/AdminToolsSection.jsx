...
import { 
  BarChart3, Settings, Users, CheckSquare, List
} from 'lucide-react';
...
const AdminToolsSection = () => {
  ...
  // 관리자 메뉴 정의
  // '회원/신고 관리' 경로를 '게시글/리뷰 관리'와 동일하게 변경합니다.
  const adminMenus = [
    { 
      name: '게시글/리뷰 관리', 
      path: '/admin/board', 
      ...
      <div className="grid grid-cols-2 gap-3">
        {adminMenus.map((menu) => (
          <div 
            ...
            className={`cursor-pointer p-3 ${menu.bgColor} rounded-xl flex flex-col items-center justify-center hover:bg-opacity-80 transition-all`}
          >
